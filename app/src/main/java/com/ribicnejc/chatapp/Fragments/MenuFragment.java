...
public class MenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnGeneralChat = (Button) v.findViewById(R.id.btn_general_chat);
        btnGeneralChat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MainChatActivity mainChatActivity = (MainChatActivity) getActivity();
                mainChatActivity.startGeneralChatFragment();
            }
        });

        Button btnAddFriend = (Button) v.findViewById(R.id.btn_add_friend);
        btnAddFriend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MainChatActivity mainChatActivity = (MainChatActivity) getActivity();
                mainChatActivity.startAddFriendFragment();
            }
        });

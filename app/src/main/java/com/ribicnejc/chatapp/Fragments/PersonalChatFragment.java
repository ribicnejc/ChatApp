 ...
 * {@link PersonalChatFragment.OnPersonalChatFragmentInteractionListener} interface
...
public class PersonalChatFragment extends Fragment {
    ...
    private OnPersonalChatFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnPersonalChatFragmentInteractionListener) {
            mListener = (OnPersonalChatFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnPersonalChatFragmentInteractionListener {
